...
## Current Performance Summary
  ...
  Your mIoU directly measures semantic controllability — how well the ControlNet steers the generation to match the input semantic maps. At 45.60%, roughly half the semantic
