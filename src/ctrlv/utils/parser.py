def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="kitti",
        choices=['kitti', 'vkitti', 'mkitti', 'cityscapes', 'bdd100k', 'waymo', 'nuscenes', 'lyft', 'davis', 'kitti360'],
        help=(
    ...
    if args.use_segmentation:
        assert args.dataset_name in ["bdd100k", "davis", "kitti360"], "Segmentation is only supported for bdd100k, davis, and kitti360 datasets."
